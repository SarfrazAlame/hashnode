    ...
    <div>
      <div className="flex justify-between">
        ...
        <div className="flex items-center gap-3">
          <p className="text-[13px] px-2 py-0.5 rounded-full bg-gray-100 dark:bg-gray-900 cursor-pointer">{post.category}</p>
          <Bookmark size={20} className="text-slate-600 dark:text-slate-400 cursor-pointer"/>
        </div>
      </div>
    </div>
  );
